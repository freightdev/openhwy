...
export default function FullDispatcherAgreementPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    commissionRate: '8%',
    paymentTerms: 'Weekly',
    authority: 'Full dispatch authority including load selection, rate negotiation, and customer communication',
    responsibilities: 'Full responsibility for load management, driver communication, and delivery coordination',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // TODO: Submit to API
    addToast('Dispatcher agreement saved successfully', 'success')
  }

  const handleDownload = () => {
    addToast('Downloading Full Dispatcher Agreement...', 'info')
    // TODO: Generate PDF and download
  }

  const handleSendForSignature = () => {
    addToast('Sending agreement for e-signature...', 'info')
    // TODO: Send to DocuSign or similar
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <h1 className="text-3xl font-bold">Full Dispatcher Agreement</h1>
          <p className="text-gray-400 mt-2">8% service fee - Complete dispatch authority</p>
        </div>
          ...
          <div className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] rounded-xl border border-white/10 p-6 space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="font-semibold">Full Dispatcher Agreement</p>
              </div>
              <div>
                <p className="text-gray-400">Commission</p>
                <p className="font-semibold text-green-400">8%</p>
              </div>
              <div>
